...
function LotteryInfo() {
    ...
    return (
        <div className='row justify-content-center align-items-center mt-5'>
            <div className='col-8'>
                <h4 className='mb-3'><b>Lottery No {stateLotteryNo && stateLotteryNo.transaction ? stateLotteryNo.transaction.toNumber() : "..."}</b></h4>
                <h4 className='mb-3'><b>Total Money Collected by Lottery: {stateMoneyCollected && stateMoneyCollected.transaction ? stateMoneyCollected.transaction.toNumber() : "..."}</b></h4>
                <h4 className='mb-5'><b>Last Owned Ticket Id: {stateLastOwnedTicketNo && stateLastOwnedTicketNo.transaction ? stateLastOwnedTicketNo.transaction[0].toNumber() : "..."}</b></h4>
                <div className='row justify-content-center align-items-center mb-5'>
                    ...
                    <p className='mt-3'><b>
                        {stateIthOwnedTicketNo && stateIthOwnedTicketNo.transaction && stateIthOwnedTicketNo.errorMessage && `Ticket Id: ${stateIthOwnedTicketNo.transaction[0].toNumber()}`}
                        {stateIthOwnedTicketNo && !stateIthOwnedTicketNo.transaction && stateIthOwnedTicketNo.errorMessage}
                    </b></p>
                </div>
                <div className='row justify-content-center align-items-center mb-5'>
                    <TextField className='mb-2' type="number" label="Index" value={index} onChange={e => setWinningIndex(e.target.value)} />
                    <ProgressButton onClick={handleIthWinningTicketNo} text="Get Ith Winning Ticket Id" />
                    <p className='mt-3'><b>
                        {stateIthWinningTicketNo && stateIthWinningTicketNo.transaction && stateIthWinningTicketNo.errorMessage && `Ticket Id: ${stateIthWinningTicketNo.transaction[0].toNumber()}`}
                ...
                <div className='row justify-content-center align-items-center mb-5'>
                    ...
                    <p className='mt-3'><b>
                        {stateIfTicketWon && stateIfTicketWon.transaction && stateIfTicketWon.errorMessage && `Ticket Id: ${stateIfTicketWon.transaction[0].toNumber()}`}
